...
<div class="mb-7 flex items-start justify-between gap-4">
    <div><h2 class="page-title">{{ $product->exists ? 'แก้ไขรายการ' : 'สร้างรายการใหม่' }}</h2><p class="page-subtitle">อะไหล่เพิ่มได้ทันที ส่วนวิชและ FG ให้กำหนดสูตรที่ใช้ต่อ 1 ชิ้น</p></div>
