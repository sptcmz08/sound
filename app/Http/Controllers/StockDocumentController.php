...
class StockDocumentController extends Controller
{
    ...
    {
        return view('documents.show', ['document' => $document->load(['items.product.unit', 'items.options.optionItem.group', 'items.options.optionItem.optionProduct', 'transactions.product.unit', 'warehouse', 'creator', 'poster', 'reversal'])]);
    }
