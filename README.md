# Simple Part & FG Stock Control

ระบบคุมสต๊อกภาษาไทยบน Laravel 12 / PHP 8.2 สำหรับ Part และ FG รองรับรับเข้า จ่ายออก ปรับยอด Reversal, Stock Card, รายงาน Excel/CSV, Import สินค้า, ผู้ใช้ 3 ระดับ และ Audit Log
...
3. ใช้เมนู **รับ Part** หรือ **รับ FG** เลือกคลังและสินค้า ใส่จำนวน แล้วบันทึกเอกสารรับเข้า
4. ใช้เมนู **จ่าย Part** หรือ **จ่าย FG** เพื่อจ่ายออก ระบบจะไม่อนุญาตให้ยอดติดลบ
5. ตรวจยอดที่ **สต็อกคงเหลือ** และดูประวัติรายสินค้าที่ **Stock Card**
