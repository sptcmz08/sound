# PART / SUPPLY / WIP / FG Stock Control

ระบบคุมสต็อกภาษาไทยบน Laravel 12 / PHP 8.2 สำหรับ PART, SUPPLY, WIP และ FG รองรับรับเข้าจาก Supplier, เบิก-จ่าย, ผลิต WIP/FG ตามสูตร, ขาย, เคลม, ของเสีย, ต้นทุน-กำไร, Reversal, Stock Card, รายงาน Excel/CSV, Import สินค้า, ผู้ใช้ 3 ระดับ และ Audit Log
...
3. ใช้เมนู **รับเข้า (Supplier)** เพื่อรับ PART, SUPPLY, WIP หรือ FG พร้อมต้นทุนเข้าสต็อก
...
PART คืออะไหล่หรือชิ้นส่วนที่กำหนดจำนวนต่อสูตรผลิตได้ ส่วน SUPPLY คือวัสดุสิ้นเปลืองที่รับและเบิกแยกจาก PART โดยไม่ผูกจำนวนต่อชิ้นงาน สูตร WIP ใช้ PART และสูตร FG ใช้ WIP/PART เท่านั้น สำหรับ FG สามารถสร้างกลุ่ม Option จาก WIP/PART เพื่อให้ลูกค้าเลือกตอนขาย ระบบจะตัดสต็อก Option และรวมต้นทุนเข้ารายงานกำไรอัตโนมัติ
